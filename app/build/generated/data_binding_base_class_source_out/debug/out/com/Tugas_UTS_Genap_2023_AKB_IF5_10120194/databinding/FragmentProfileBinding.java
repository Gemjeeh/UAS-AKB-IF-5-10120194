...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull RelativeLayout rootView, @NonNull CircleImageView foto,
      @NonNull TextView txtEmail, @NonNull TextView txtKelas, @NonNull TextView txtNama,
      @NonNull TextView txtNim) {
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((RelativeLayout) rootView, foto, txtEmail, txtKelas,
          txtNama, txtNim);
    }
