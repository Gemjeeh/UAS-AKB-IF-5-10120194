...
public final class ItemNoteBinding implements ViewBinding {
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.desc_note;
      TextView descNote = ViewBindings.findChildViewById(rootView, id);
      if (descNote == null) {
        break missingId;
      }
      ...
      return new ItemNoteBinding((RelativeLayout) rootView, categoryNote, dateNote, descNote,
          titleNote);
    }
